import { type Color, randomColor, randomPleasantColor } from "@germondai/security";
...
export const colorLeaf = defineCommand({
  ...
  args: {
    ...
    pleasant: {
      type: "boolean",
      description: "Constrain saturation/lightness for a pleasant palette.",
    },
    format: {
      type: "string",
      shortAlias: "f",
      default: "all",
      description: "all | hex | rgb | hsl | json",
    },
  },
  run({ args }) {
    try {
