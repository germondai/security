...
import { shannonEntropy, detectPoolSize, naiveEntropyBits } from '../src/analyzers/entropy.js';
...
describe('shannonEntropy', () => {
  ...
  test('all-distinct string is log2(n)', () => expect(shannonEntropy('abcd').toFixed(4)).toBe('2.0000'));
});
