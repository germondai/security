...
export function toBase32(b: Uint8Array): string {
  return b32encode(b, B32_ALPH);
}
export function fromBase32(s: string): Uint8Array {
  return b32decode(s, B32_ALPH);
}
export function toBase32Hex(b: Uint8Array): string {
  return b32encode(b, B32_HEX_ALPH);
}
export function fromBase32Hex(s: string): Uint8Array {
  return b32decode(s, B32_HEX_ALPH);
}
...
export function fromBase58(s: string): Uint8Array {
  return new Uint8Array(b58decode(s));
}
