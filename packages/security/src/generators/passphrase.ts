import { secureRandomPick, secureRandomInt } from '../internal/random.js';
import { utf8Encode } from '../internal/encoding.js';

const WORDS: readonly string[] = [
  'abbey', 'able', 'abroad', 'abstract', 'academy', 'accent', 'acid', 'acoustic',
  'acquire', 'across', 'action', 'actor', 'actress', 'actual', 'adapt', 'adjust',
  'admit', 'adult', 'advance', 'advise', 'aerobic', 'affair', 'afford', 'afraid',
  ...
  'arrest', 'arrive', 'arrow', 'art', 'artist', 'artwork', 'ask', 'aspect', 'assault',
  ...
  'camera', 'camp', 'canal', 'cancel', 'candy', 'cannon', 'canoe', 'canvas', 'canyon',
  'capable', 'capital', 'captain', 'car', 'carbon', 'card', 'cargo', 'carpet', 'carry',
  'cart', 'case', 'cash', 'casino', 'castle', 'casual', 'cat', 'catalog', 'catch',
  ...
  'cute', 'cycle', 'dad', 'damage', 'damp', 'dance', 'danger', 'daring', 'dash',
  ...
  'dry', 'duck', 'dumb', 'dune', 'during', 'Dutch', 'duty', 'dwarf', 'dynamic', 'eager',
  ...
  'garlic', 'gas', 'gate', 'gather', 'gauge', 'gaze', 'general', 'genius', 'genre',
  ...
  'harsh', 'harvest', 'hat', 'have', 'hawk', 'hazard', 'head', 'heart', 'heavy', 'hedgehog',
  'height', 'hello', 'helmet', 'help', 'hen', 'hero', 'hidden', 'high', 'hill', 'hint',
  'hip', 'hire', 'history', 'hobby', 'hockey', 'hold', 'hole', 'holiday', 'hollow',
  'home', 'honey', 'hood', 'hope', 'horn', 'horror', 'horse', 'hospital', 'host', 'hot',
  'hotel', 'hour', 'house', 'human', 'humble', 'humor', 'hundred', 'hungry', 'hunt',
  'hurdle', 'hurry', 'hurt', 'husband', 'hybrid', 'ice', 'icon', 'idea', 'idle', 'ignore',
  'ill', 'illegal', 'illness', 'image', 'imitate', 'immense', 'immune', 'impact', 'impose',
  'improve', 'include', 'income', 'increase', 'index', 'indicate', 'indoor', 'industry',
  ...
  'iron', 'island', 'isolate', 'issue', 'item', 'ivory', 'jacket', 'jaguar', 'jail',
  'jaguar', 'jazz', 'jealous', 'jeans', 'jelly', 'jewel', 'job', 'join', 'joke', 'journey',
  'joy', 'judge', 'juice', 'jump', 'jungle', 'junior', 'junk', 'just', 'kangaroo', 'karate',
  'keen', 'keep', 'ketchup', 'key', 'kick', 'kid', 'kidney', 'kind', 'kingdom', 'kiss',
  'kit', 'kitchen', 'kite', 'kitten', 'kiwi', 'knee', 'knife', 'knock', 'know', 'lab',
  'label', 'labor', 'ladder', 'lady', 'lake', 'lamb', 'lamp', 'language', 'laptop',
  'large', 'later', 'latin', 'laugh', 'laundry', 'lava', 'law', 'lawn', 'lawsuit', 'layer',
  'lazy', 'leader', 'leaf', 'learn', 'leave', 'lecture', 'left', 'leg', 'legal', 'legend',
  'leisure', 'lemon', 'lend', 'length', 'lens', 'leopard', 'less', 'lesson', 'letter',
  'level', 'liberty', 'library', 'license', 'life', 'lift', 'light', 'like', 'limb', 'lime',
  'limit', 'link', 'lion', 'liquid', 'list', 'little', 'live', 'lizard', 'load', 'loaf',
  'loan', 'lobby', 'local', 'lock', 'log', 'logic', 'lonely', 'long', 'loop', 'lord',
  'lose', 'loss', 'lottery', 'loud', 'lounge', 'love', 'loyal', 'lucky', 'luggage', 'lumber',
  ...
  'meadow', 'mean', 'measure', 'meat', 'mechanic', 'medal', 'media', 'melody', 'melon',
  ...
  'mixed', 'model', 'modify', 'mom', 'moment', 'monitor', 'monkey', 'monster', 'month',
  'moon', 'moral', 'more', 'morning', 'mosquito', 'mother', 'motion', 'motor', 'mountain',
  'mouse', 'move', 'movie', 'much', 'muffin', 'mule', 'multiply', 'muscle', 'museum',
  'music', 'must', 'myself', 'mystery', 'myth', 'naive', 'name', 'napkin', 'narrow',
  'nasty', 'nation', 'nature', 'near', 'nearly', 'neck', 'need', 'negative', 'neglect',
  'neither', 'nephew', 'nerve', 'nest', 'net', 'network', 'neutral', 'never', 'next',
  'nice', 'night', 'noble', 'noise', 'nominate', 'noodle', 'normal', 'north', 'nose',
  ...
  'opera', 'opinion', 'oppose', 'option', 'orange', 'orbit', 'orchard', 'order', 'organ',
  ...
  'paper', 'parade', 'parent', 'park', 'parrot', 'party', 'pass', 'patch', 'path',
  ...
  'purity', 'purpose', 'push', 'put', 'puzzle', 'pyramid', 'quality', 'quantum', 'quarter',
  ...
  'reward', 'rhythm', 'rib', 'rice', 'rich', 'ride', 'ridge', 'rifle', 'right', 'rigid',
  ...
  'spider', 'spike', 'spin', 'spirit', 'split', 'sponsor', 'spoon', 'sport', 'spot',
  ...
  'sustain', 'swallow', 'swamp', 'swap', 'swarm', 'swear', 'sweet', 'swift', 'swim',
  'swing', 'switch', 'sword', 'symbol', 'symptom', 'syrup', 'system', 'table', 'tackle',
  ...
  'upgrade', 'uphold', 'upon', 'upper', 'upset', 'urban', 'urge', 'usage', 'used', 'useful',
  ...
  'warfare', 'warm', 'warrior', 'wash', 'wasp', 'waste', 'water', 'wave', 'weak', 'wealth',
  ...
  'winter', 'wire', 'wisdom', 'wise', 'wish', 'with', 'witness', 'wolf', 'woman', 'wonder',
...
export function generatePassphrase(opts: PassphraseOptions = {}): string {
  ...
  for (let i = 0; i < n; i++) {
    const w = secureRandomPick(WORDS) as string;
    picked[i] = opts.capitalize ? w.charAt(0).toUpperCase() + w.slice(1) : w;
  }
  let out = picked.join(sep);
  if (opts.includeNumber) {
    const nStr = String(secureRandomInt(0, 1000));
    out = sep === '' ? picked.join(nStr) : `${out}${sep}${nStr}`;
  }
  return out;
}
